...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      const servicio = document.getElementById('personas').value;

      if (nombre && fecha && hora && servicio) {
        // Simulación de envío (Actualizar con endpoint real de MS Studio)
        fetch('https://formspree.io/f/contacto@msstudio.uy', {
          method: 'POST',
          body: new FormData(form),
          headers: { 'Accept': 'application/json' }
        }).catch(err => console.log('Simulación de envío:', nombre));
        ...
        document.getElementById('modalGuests').textContent = servicio;
